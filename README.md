...
DETALHE - Se quiser ver as tabelas criadas no PGadmin, basta você abrir o app e criar um server novo, 
as configurações do servidor são os códigos que rodamos lá no PASSO 4 (nome, user, senha, hostname e a porta)
