...
function salvarDados() {
    ...
    var corpoArquivoCliente = clientes
    ...
    var corpoArquivoProdutos = produtos
    ...
    if (fs.existsSync(PEDIDOS_CSV) && fs.existsSync(ITENS_PEDIDO_CSV)) {
        ...
        pedidos = pedidosData
            ...
            var itensDestePedido = todosItens_1
                ...
                var produtoDoItem = produtos.find(function (p) { return p.id === itemInfo.produto_id; }); // Medida de segurança: se o produto não for encontrado, pulamos este item.
                if (!produtoDoItem)
